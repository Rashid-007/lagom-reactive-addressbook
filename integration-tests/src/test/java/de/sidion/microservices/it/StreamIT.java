package de.sidion.microservices.it;
...
import de.sidion.microservices.addressbook.api.GreetingMessage;
...
public class StreamIT {
    ...
    public static void setup() {
        ...
        addressBookService = clientFactory.createDevClient(AddressBookService.class, URI.create(SERVICE_LOCATOR_URI));
    ...
    public void helloWorld() throws Exception {
        String answer = await(addressBookService.hello("foo").invoke());
        assertEquals("Hello, foo!", answer);
        await(addressBookService.useGreeting("bar").invoke(new GreetingMessage("Hi")));
        String answer2 = await(addressBookService.hello("bar").invoke());
